-- ===========================================
-- Fix RPC Function to use correct order status (UPPERCASE)
-- ===========================================
-- Master Prompt Seksyen 32: ORDER STATUS
-- ===========================================
-- Status harus: PENDING, ACCEPTED, READY, DELIVERING, COMPLETED, CANCELLED
-- Bukan 'New', 'Accepted', 'Preparing', 'Ready', 'Completed', 'Cancelled'
...
'Atomic order creation with stock validation and price verification - Updated to use PENDING status';

DO $$
BEGIN
  RAISE NOTICE '✅ RPC Function updated: create_order_with_stock_check() now uses PENDING status';
  RAISE NOTICE 'Status corrected from "New" to "PENDING" to match check constraint';
END $$;
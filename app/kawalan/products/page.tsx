...
export default function AdminProductsManagementPage() {
  ...
  async function handleCreateProduct() {
    ...
    try {
      ...
      await fetchAllProducts();
      alert('Produk baru berjaya dicipta!');
    } catch (error: any) {
      alert('Ralat: ' + error.message);
    }
  }
